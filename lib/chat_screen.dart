...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final ChatsModel _chatsModel = Provider.of<ChatsModel>(context);
      UserModel _userModel = Provider.of<UserModel>(context);
      _chatsModel.enterChat(_userModel.user.userID,widget.chatID);
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Center(
        child: Column(
          children: <Widget>[
            _buildMessages(_userModel, _chatID),
  ...
  Expanded _buildMessages(UserModel _userModel, String _chatID) {
    return Expanded(
  ...
  messageBallon(
    ...
    try {
      _messageTime = _timeConvert(date ?? Timestamp(2,2));
    } catch (e) {}
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            top: 2.0, left: 15.0, right: 10.0, bottom: 10.0),
                        child: Text(
                          messageText,
                          style: TextStyle(
